    ...
    <div className="space-y-5 pb-10">
      ...
      <div className="space-y-3">
        <div className="flex gap-2 flex-col sm:flex-row">
          ...
          <select
            ...
            className="bg-white text-sm text-slate-700 px-3 py-2 rounded-lg border border-slate-200 focus:outline-none focus:border-brand-blue focus:ring-1 focus:ring-brand-blue/20 transition sm:w-44 appearance-none cursor-pointer"
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center gap-3">
          ...
          <div>
            <p className="text-slate-700 font-medium text-sm">No events found</p>
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center justify-between pt-1.5 border-t border-slate-100">
                        ...
                        {isPast ? (
                          <span className="text-2xs text-slate-400">Done</span>
                        ) : (
                          <span className="text-2xs text-emerald-600 font-medium">Upcoming</span>
                        )}
                      </div>
                    </div>
                  </Card>
